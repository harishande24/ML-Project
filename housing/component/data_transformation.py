...
class DataTransformation:
    ...
    def load_data(file_path:str,schema_file_path:str)->pd.DataFrame:
        try:
            ...
            rasie HousingException(e,sys) from e
    

    def get_data_transformer_object(self)->ColumnTransformer:
        try:
            schema_file_path = self.data_validation_artifact.get_schema_file_path
    ...
    def intiate_data_transformation(self)->DataTransformationArtifact:
        try:
            ...
            prerocessing_obj = self.get_data_transformer_object()

            logging.info(f"Getting preprocessing object and training and testing file path")
